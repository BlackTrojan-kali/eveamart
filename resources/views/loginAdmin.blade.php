...
<body class="bg-blue-100 font-Rob">
    <section class="block m-4 md:mx-60 md:my-10  md:flex rounded-md   bg-white  md:overflow-hidden md:m-24 shadow-lg md:w-2/3" >
        <div class="hidden lg:block  overflow-hidden w-2/3">
            <img src="/images/adminlogin.jpg" class="w-full h-full"  alt="">            
        </div>
        <div class="p-3  block w-11/12">
            ...
            <div class=" p-4 ">
                ...
                <p class="py-2">
                    se connecter en tant que utilisateur? <a class="text-green-500" href="{{route("login")}}"> connexion</a>
                </p>
            </div>
        </div>
    </section>    
