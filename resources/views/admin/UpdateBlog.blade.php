...
<div class="w-full bg-slate-300 h-full px-4 md:px-10 py-5">
    ...
    <div class="w-full md:w-11/12">
        ...
        <form action="{{route('UpdateTheBlog',$blog->id)}}" enctype="multipart/form-data" method="POST" class="w-full">
            @csrf
        <div class="w-full box">
            <h2 class="font-bold">
                ...
                <div class="inputs">
                    ...
                    <input name="title1" value="{{$blog->title1}}" required type="text" class="my-input" placeholder="titre du blog">
                ...
                <div class="inputs">
                    ...
                    <textarea name="text1"  required id="" class="my-text-input" >
                        @if (isset($blog->text1))
                            {{$blog->text1}}
                        @endif
                    </textarea>
                ...
                <div class="inputs">
                    ...
                    <input type="text" value="{{$blog->title2}}" name="title2" class="my-input" placeholder="titre du blog">
